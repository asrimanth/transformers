...
1. **[EDSR](https://huggingface.co/docs/transformers/main/model_doc/edsr)** (from Seoul National University, Seoul, Korea) released with the paper [Enhanced Deep Residual Networks for Single Image Super-Resolution](https://arxiv.org/abs/1707.02921) by Bee Lim, Sanghyun Son, Heewon Kim, Seungjun Nah, Kyoung Mu Lee.
